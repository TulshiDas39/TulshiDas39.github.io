...
const about = {
  title: "About me",
  description:
    "I am Tulshi Chandra Das, a software engineer with over 5 years of experience in the industry. I specialize in web, mobile, and desktop application development, and have a strong background in web application development. I am passionate about creating innovative solutions that drive business success. I am available for freelance projects and fluent in both English and Bengali.",
  info: [
    { fieldName: "Name", fieldValue: "Tulshi Chandra Das" },
    { fieldName: "Phone", fieldValue: "+880 1580614567" },    
    { fieldName: "Experience", fieldValue: "5+ Years" },
    { fieldName: "Nationality", fieldValue: "Bangladeshi" },
    { fieldName: "Email", fieldValue: "tulshidas37@gmail.com" },
